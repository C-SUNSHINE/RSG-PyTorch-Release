...
__all__ = ['RRTNode', 'RRT', 'smooth_path', 'rrt', 'birrt']
...
def smooth_path(pspace, path, nr_attemps=100):
...
def birrt(pspace, start_state, goal_state, nr_iterations=1000, nr_smooth_iterations=None):
    ...
    for i in range(nr_iterations):
        ...
        if next_config is not None:
            ...
            if success:
                ...
                return smooth_path(pspace, path, nr_smooth_iterations), (rrt_start, rrt_goal)
